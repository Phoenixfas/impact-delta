...
const METRICS: Metric[] = [
  {
    icon: CalendarDays,
    label: "Custom Exhibition Stands Fabricated",
    description: "Bespoke double-decker pavilions, modular shell scheme upgrades, and high-impact DEC & DWTC builds.",
    target: 500,
    decimals: 0,
    suffix: "+",
    size: "large",
  ...
  {
    icon: Users,
    label: "Global Operational Hubs",
    description: "Active hubs across UAE, Europe, USA, Africa, and Asia.",
    target: 9,
    decimals: 0,
    suffix: " Countries",
    size: "small",
  ...
  {
    icon: Star,
    label: "Client Satisfaction & ISO Quality",
    description: "Triple ISO certified: 9001, 14001, 45001.",
    target: 99.8,
    decimals: 1,
    suffix: "%",
    size: "small",
    image: "/images/prev/booth_2.webp",
    alt: "Client exhibition booth by Impact Makers Events",
  },
];
