...
const SERVICE_DOMAINS: ServiceDomain[] = [
  {
    id: "fabrication",
    category: "01 // IN-HOUSE DUBAI WORKSHOP",
    title: "Custom Exhibition Stand Fabrication",
    subtitle: "In-House CNC Joinery, Structural Steel & Double-Decker Pavilions",
    description:
      "Engineered in our dedicated Dubai carpentry and metalworking facility. We deliver bespoke exhibition stands, modular shell upgrades, and double-decker pavilions with zero subcontractor dependency.",
    icon: Layers,
    metrics: [
      { label: "Workshop Tolerance", value: "±0.5mm" },
      { label: "On-Time Handover", value: "100%" },
      { label: "Stands Delivered", value: "500+" },
    ],
    features: [
      "In-House 5-Axis CNC Router & Wood Joinery",
      "Structural Steel Engineering & DWTC/DEC Approvals",
      "3D Max & V-Ray Photorealistic Architectural Previz",
    ],
  ...
  {
    id: "management",
    category: "02 // INTERNATIONAL CONGRESSES",
    title: "Event Management & Organizing",
    subtitle: "B2B Trade Shows, Diplomatic Summits & Corporate Activations",
    description:
      "End-to-end turnkey event orchestration. From delegate ticketing and VIP ministerial protocol to plenary stage calling and multi-hall logistics across Dubai and global venues.",
    icon: Globe2,
    metrics: [
      { label: "Global Hubs", value: "9 Countries" },
      { label: "Client CSAT", value: "99.8%" },
      { label: "Delegates Managed", value: "250K+" },
    ],
    features: [
      "Full On-Site Operations & Stage Management",
      "Diplomatic Protocol & High-Security Access Routing",
      "DEC, DWTC & ADNEC Venue Authority Compliance",
    ],
  ...
  {
    id: "audiovisual",
    category: "03 // CONCERT AV & 4K BROADCAST",
    title: "Audiovisual, Stage Lighting & Media",
    subtitle: "Curved 4K LED Video Walls, Line Array Acoustics & 4K Livestreaming",
    description:
      "Turnkey broadcast-grade event technology. Ultra-fine pitch LED ribbon walls, concert-grade acoustic arrays, robotic stage lighting, and multi-camera 4K livestream flypacks.",
    icon: Cpu,
    metrics: [
      { label: "LED Wall Stock", value: "15,000 m²" },
      { label: "Audio Output", value: "100% Clean" },
      { label: "Video Latency", value: "< 0.1 ms" },
    ],
    features: [
      "Fine-Pitch Curved 4K LED Video Displays",
      "Concert Line Array Audio & DMX Stage Lighting",
      "4K Multi-Camera Live Broadcast & Post-Event Media",
    ],
  ...
  {
    id: "commercial",
    category: "04 // COMMERCIAL & DESIGNER RENTALS",
    title: "Space Selling, VIP Gifts & Furniture",
    subtitle: "Floor Plan Monetization, Executive Gifts & Designer Seating",
    description:
      "Complete commercial and finishing services. We monetize trade show floor plans, supply premium corporate VIP gift sets, and rent luxury designer furniture (Knoll, Corbusier, Tolix).",
    icon: ShieldCheck,
    metrics: [
      { label: "Floor Space Sold", value: "150K m²" },
      { label: "Furniture Catalog", value: "2,500+ Pcs" },
      { label: "ISO Certified", value: "Triple ISO" },
    ],
    features: [
      "Exhibition Floor Plan Space Sales & Sponsorships",
      "Designer Event Furniture Rental & Lounge Styling",
      "Luxury Corporate Gifts, Executive Kits & Merchandise",
    ],
    gradient: "from-indigo-600 via-blue-600 to-cyan-600",
    accentColor: "#1E40AF",
    badge: "TURNKEY ASSETS",
  },
];
