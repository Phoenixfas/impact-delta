...
const STORY_CHAPTERS: StoryChapter[] = [
  {
    ...
    chapterNumber: "01",
    year: "Foundations",
    category: "The In-House Atelier",
    title: "Mastering In-House Fabrication & Craft",
    quote: "“A brand space should never be compromised by subcontractor shortcuts. True quality demands direct, hands-on workshop control.”",
    paragraphs: [
      "Impact Makers Events was established with a clear mandate: eliminate the unpredictability of third-party middlemen by building a fully integrated, in-house carpentry, joinery, and structural steel workshop in Dubai.",
      "By controlling every CNC cut, paint finish, and structural weld under our own roof, we proved that custom exhibition stands could be delivered with millimeter accuracy, zero load-in delays, and flawless luxury finishes.",
      "From custom modular builds to ambitious double-decker pavilions at Dubai World Trade Centre (DWTC) and Dubai Exhibition Centre (DEC), our early projects set a new standard for craftsmanship across the GCC.",
    ],
    image: "/images/prev/01.webp",
    alt: "In-house custom exhibition stand fabrication in Dubai by Impact Makers Events",
    icon: BookOpen,
    badge: "In-House Workshop",
    metric: { value: "100%", label: "In-House Joinery Control" },
  ...
  },
  {
    ...
    title: "Connecting Businesses Across 9 Countries",
    quote: "“Connecting businesses worldwide means delivering the exact same engineering precision in Dubai, Lisbon, Warsaw, and Singapore.”",
    paragraphs: [
      "As multinational clients demanded turnkey consistency across their global tour calendars, Impact Makers Events established active operational hubs across 9 key nations.",
      "Today, our footprint spans the United Arab Emirates (HQ), Poland, Portugal, Netherlands, Germany, the United States, Singapore, Rwanda, and Ethiopia.",
      "Whether delivering an aerospace pavilion in Dubai, a diplomatic congress in Europe, or a high-tech expo in Asia, our unified project management framework ensures seamless execution across borders.",
    ],
    image: "/images/prev/atss-1-landscape.webp",
    alt: "Global event production and international exhibition operations",
    icon: Globe2,
    badge: "9 Global Hubs",
    metric: { value: "9 Hubs", label: "Active Country Footprint" },
  ...
  },
  {
    ...
    chapterNumber: "03",
    year: "Accreditation",
    category: "Operational Rigor",
    title: "Triple ISO Certified Excellence",
    quote: "“Trust is earned through rigorous compliance, verified safety, and uncompromising environmental stewardship.”",
    paragraphs: [
      "To provide our international corporate and government partners with absolute operational confidence, Impact Makers Events underwent comprehensive third-party audits to secure Triple ISO Accreditations.",
      "We are certified under ISO 9001:2015 for Quality Management, ISO 14001:2015 for Environmental Sustainability, and ISO 45001:2018 for Occupational Health & Safety.",
      "From flame-retardant material selection and green material strikes to zero-accident load-in protocols, our ISO frameworks govern every square meter of our fabrication and on-site assembly.",
    ],
    image: "/images/prev/14.webp",
    alt: "Triple ISO certified exhibition management and safety protocols",
    icon: ShieldCheck,
    badge: "Triple ISO Certified",
    metric: { value: "100%", label: "ISO Audit Compliance" },
  ...
  },
  {
    ...
    chapterNumber: "04",
    year: "2026 & Beyond",
    category: "Turnkey Leadership",
    title: "The Complete Event & Exhibition Ecosystem",
    quote: "“From concept to reality — bringing together stand building, audiovisual stagecraft, space monetization, and designer rentals under one roof.”",
    paragraphs: [
      "Today, Impact Makers Events L.L.C is a full-spectrum event powerhouse. We unite custom 3D stand fabrication, international congress organizing, concert-grade sound & lighting, commercial space selling, corporate VIP gifting, and designer furniture rental.",
      "Having delivered over 500+ successful stands and summits with a 99.8% client satisfaction rate, we partner with industry leaders including Airbus, Bloomberg, CNBC, ADCB, Red Bull, Samsung, and government entities.",
      "We invite event organizers, brand directors, and corporate leaders to experience a collaborative partnership where imagination meets flawless execution.",
    ],
    image: "/images/prev/booth_2.webp",
    alt: "Turnkey exhibition stand fabrication and grand pavilion build",
    icon: Zap,
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto mb-20 sm:mb-28 text-left">
        ...
        <p className="story-intro-el mt-5 text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl">
          Follow the architectural and technical journey of how Impact Makers Events L.L.C transformed the enterprise
