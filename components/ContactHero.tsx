...
const DIRECT_CHANNELS: DirectChannel[] = [
  {
    ...
    subtitle:
      "Direct line to senior production engineers and executive summit logistics directors.",
    primaryValue: "+1 (800) 845-4672",
    secondaryValue: "WhatsApp: +1 (555) 392-8820",
    primaryActionLabel: "Direct Dial",
    primaryActionHref: "tel:+18008454672",
    primaryActionIcon: PhoneCall,
    secondaryActionLabel: "WhatsApp Chat",
    secondaryActionHref: "https://wa.me/15553928820",
    secondaryActionIcon: MessageCircle,
    copyValue: "+18008454672",
    copyLabel: "Copy Phone Number",
    statusText: "Global Desk Live · < 5 Min Response",
    tags: ["24/7 VIP Escalation", "Show Control Hotline", "Immediate Dispatch"],
  ...
  },
  {
    ...
    subtitle:
      "Submit event briefs, technical rigging specifications, or architectural discovery scopes.",
    primaryValue: "inquire@impact-delta.com",
    secondaryValue: "RFP Desk: proposals@impact-delta.com",
    primaryActionLabel: "Send Email",
    primaryActionHref: "mailto:inquire@impact-delta.com?subject=New%20Summit%20Inquiry%20%E2%80%94%20Impact%20B2B",
    primaryActionIcon: Send,
    secondaryActionLabel: "Schedule Briefing",
    secondaryActionHref: "#schedule",
    secondaryActionIcon: ArrowUpRight,
    copyValue: "inquire@impact-delta.com",
    copyLabel: "Copy General Email",
    statusText: "Encrypted Desk · Same-Day RFP Review",
    tags: ["Scope Estimation", "Technical Previz", "NDA Protected"],
    gradientAccent: "from-[#003E95]/10 via-[#00A7F5]/5 to-transparent",
    borderAccent: "group-hover:border-[#00A7F5]/50",
  },
  {
    id: "press",
    badge: "PRESS, MEDIA & KEYNOTES",
    badgeColor: "bg-sky-50 text-sky-700 border-sky-200/80",
    title: "Press & Media Relations",
    subtitle:
      "Media credentials, executive interview requests, 8K showreel assets, and speaker bureaus.",
    primaryValue: "press@impact-delta.com",
    secondaryValue: "Media Kit: 2026 Press Pack (8K)",
    primaryActionLabel: "Media Inquiry",
    primaryActionHref: "mailto:press@impact-delta.com?subject=Press%20%26%20Editorial%20Inquiry",
    primaryActionIcon: Mail,
    secondaryActionLabel: "Press Assets",
    secondaryActionHref: "mailto:press@impact-delta.com?subject=Press%20Kit%20Request",
    secondaryActionIcon: FileDown,
    copyValue: "press@impact-delta.com",
    copyLabel: "Copy Press Email",
    statusText: "Editorial Team Live · 8K Assets Ready",
    tags: ["High-Res Showreel", "Speaker Bureau", "Brand Guidelines"],
...
const GLOBAL_HUBS = [
  { city: "GENEVA", tz: "CET (UTC+1)", status: "HQ & Engineering" },
  { city: "NEW YORK", tz: "EST (UTC-5)", status: "Americas Command" },
  { city: "LONDON", tz: "GMT (UTC+0)", status: "EMEA Operations" },
  { city: "SINGAPORE", tz: "SGT (UTC+8)", status: "APAC Production" },
  { city: "DUBAI", tz: "GST (UTC+4)", status: "MENA Hub" },
];
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="contact-bottom-assist mt-12 sm:mt-16 w-full max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 p-5 rounded-2xl backdrop-blur-md bg-white/70 border border-slate-200/70 shadow-sm text-left">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <a
              href="mailto:inquire@impact-delta.com?subject=Enterprise%20RFP%20Submission%20%E2%80%94%20Impact%20B2B"
