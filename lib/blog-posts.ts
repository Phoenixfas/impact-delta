...
export const DETAILED_BLOG_POSTS: Record<string, DetailedBlogPost> = {
  "navigating-dwtc-dec-stand-guidelines": {
    ...
    heroImage: "/images/prev/atss-1-landscape.webp",
  ...
  "in-house-cnc-joinery-vs-subcontracting": {
    ...
    heroImage: "/images/prev/04_portrait.webp",
    heroImageAlt: "Vertical architectural view of custom exhibition stand joinery and venue rigging in Dubai",
  ...
  "triple-iso-standards-in-event-management": {
    ...
    heroImage: "/images/prev/08_portrait.webp",
  ...
  "the-architecture-of-awe": {
    ...
    heroImage: "/images/prev/6_portrait45.webp",
    heroImageAlt: "Spatial exhibition pavilion architecture with illuminated entrance arch and VIP seating",
  ...
  "exhibition-space-selling-playbook": {
    ...
    heroImage: "/images/prev/booth_2.webp",
...
export function mapPrismaToDetailedBlogPost(dbPost: any): DetailedBlogPost {
  ...
  return {
    ...
    heroImage: dbPost.coverImage || "/images/prev/atss-1-landscape.webp",
